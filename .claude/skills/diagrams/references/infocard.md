...
<div style="max-width: 800px; box-sizing: border-box; position: relative;">
  ...
  <div class="card">
    ...
    <p class="card-subtitle">
      A clear summary paragraph that gives readers the core message in 2-3 sentences.
    </p>
...
.card-bento-cell.span-col {
  grid-column: span 2;
}
.card-bento-cell.span-row {
  grid-row: span 2;
}
.card-bento-stat {
  font-size: 36px;
...
.card::before {
  ...
  pointer-events: none;
  opacity: 0.04;
  background-image: radial-gradient(circle at 20% 20%, rgba(0, 0, 0, 0.8) 0.5px, transparent 0.8px);
...
.card-body.dropcap::first-letter {
  font:
    900 72px/0.82 'Noto Serif SC',
    Georgia,
    serif;
  float: left;

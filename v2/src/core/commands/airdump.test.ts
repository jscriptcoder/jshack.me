...
describe('airdump', () => {
  ...
  it('streams the exact airodump-style table for a seeded scan', async () => {
    ...
    expect(lines).toEqual([
      ...
      '',
      'AE:89:6D:78:E7:DB      -62    10  WPA2    BEAN-THERE-WIFI',
      'B8:F6:FE:26:E1:E2      -63    11  WPA2    GRAD-STUDENT-WIFI',
      '07:07:76:24:B0:02      -66     6  WPA3    DIRECT-roku',
      'D6:E2:62:21:0A:CB      -66     2  WPA3    Eero-Living-Room',
      '4F:4E:1F:ED:04:0B      -60     5  WPA2    STARK-WIFI',
      '85:57:68:E0:F3:8E      -93     8  WPA2    SUBWAY_WIFI',
      '27:DE:D6:CE:88:14      -68     7  WPA3    MCDONALDS-WIFI',
      '',
      'Scan complete — 7 networks found',
    ]);
  });

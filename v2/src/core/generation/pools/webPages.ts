 ...
 * leaks the kind of thing a real server leaks: a software version, a path worth
 * trying (`/admin/`, `/server-status`), a careless comment. The player's job is to
 * read it and decide what to probe next.
 *

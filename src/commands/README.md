...
| lynx       | `lynx.ts`       | `lynx <url>`                             | Full-screen text-mode web browser (overlay). Arrow keys move between links, Enter follows, ← / Backspace pops history, q / Esc quits. HTML rendered with semantic markup; non-HTML served verbatim. Logs to target's `/var/log/access.log` like curl                                                                                                                                                                                                             |

...
| `generateDatabase.ts`    | MySQL database generator + mission enrichment functions (inject ACCESS-KEY, tamper/fix scenarios, sabotage targets into generated databases)                                                                                                                                                                                                                                                                                                                    |

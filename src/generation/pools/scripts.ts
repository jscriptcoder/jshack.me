      ...
      },
      {
        ...
        bugVariants: {
          syntax: [
            ...
            'if (unsafe.length === 1) {',
            '  echo(_decode(unsafe.map(s => s.path).join("-"))',
            '} else {',
      ...
      },
      {
        ...
        bugVariants: {
          syntax: [
            ...
            'if (healthy.length === 3) {',
            '  echo(_decode(healthy.map(n => n.host).join("-")))',
            '} else {',
      ...
      },
      {
        ...
        bugVariants: {
          syntax: [
            ...
            'if (secure.length === 2) {',
            '  echo(_decode(secure.map(v => v.domain).join("-")))',
            '} else {',
      ...
      },
      {
        ...
        bugVariants: {
          syntax: [
            ...
            'if (exposed.length === 3 {',
            '  echo(_decode(exposed.map(s => s.svc).join("-")))',
            '} else {',
      ...
      },
      {
        ...
        bugVariants: {
          syntax: [
            ...
            '  echo(_decode(outdated.map(d => d.id + ":" + d.ver).join("-")))',
            '} else {',
      ...
      },
      {
        ...
        bugVariants: {
          syntax: [
            ...
            'if (stuck.length === 2) {',
            '  echo(_decode(stuck.map(q => q.name + ":" + q.count).join("-")))',
            '} else {',
